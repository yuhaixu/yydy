...
public class AliPayController extends BaseController implements AliPayConfig {
        ...
        if (StringUtils.isNotBlank(body)) {
            ...
            for (int i = 0; i < paramArr.length; i++) {
                try {
                    ...
                    log.info("alipay_notify return param key = " + key + "  value = " + value);
                    map.put(key, value);
                } catch (Exception e) {
                    e.printStackTrace();
                    return "failure";
            ...
            try {
                ...
                if (signVerified) {
                    ...
                    if("TRADE_SUCCESS".equals(tradeStatus)){
                        payOrder(outTradeNo);
                        // 交易成功
                        log.info("alipay_notify 订单号 = " + outTradeNo);
                    }
