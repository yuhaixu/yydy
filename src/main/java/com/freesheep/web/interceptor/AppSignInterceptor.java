...
public class AppSignInterceptor implements HandlerInterceptor {
    private Logger logger = LoggerFactory.getLogger(AppSignInterceptor.class);
    @Resource
...
//                System.out.println("=============app request body==============");
...
//        }
        ...
        System.out.println("=============app request uri==============" + request.getRequestURI());
...
//        System.out.println("====================app request 验证请求===================");
