...
public class AliyunCookieCsrfTokenRepository implements CsrfTokenRepository {
    private static final String DEFAULT_CSRF_COOKIE_NAME = Constant.DEFAULT_CSRF_COOKIE_NAME;

    private static final String DEFAULT_CSRF_PARAMETER_NAME = "free_sheep_csrf";

    private static final String DEFAULT_CSRF_HEADER_NAME = "free-sheep-csrf-token";
    ...
    public AliyunCookieCsrfTokenRepository() {
